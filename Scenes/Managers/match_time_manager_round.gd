...
@onready var timer = get_node("/root/RoundLevel1v1/MatchTimeManager/Timer")
@onready var labelA = get_node("/root/RoundLevel1v1/TimerPresenter1")
@onready var labelB = get_node("/root/RoundLevel1v1/TimerPresenter2")
